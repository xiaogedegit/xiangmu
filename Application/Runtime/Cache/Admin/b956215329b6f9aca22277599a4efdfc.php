...
<script type="text/javascript" src="<?php echo Admin_PATH;?>/lib/laypage/1.2/laypage.js"></script> 
<script type="text/javascript" src="<?php echo Admin_PATH;?>/lib/My97DatePicker/WdatePicker.js"></script> 
<script type="text/javascript" src="<?php echo Admin_PATH;?>/lib/datatables/1.10.0/jquery.dataTables.min.js"></script> 
